...
In detail, the Schnorr signature verification algorithm takes a message byte string `m`, public key point _P_, and nonnegative integers _r_, _s_ as inputs, and does the following:
